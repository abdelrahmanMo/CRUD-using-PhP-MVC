...
<form class="appform"  method="post" enctype="application/x-www-form-urlencoded">
    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td><input id="username" required type="text" name="name"  placeholder="Write Your Name Here" tabindex="1" value="<?= $employee->getName(); ?>"  ></td>
            </tr>
            <tr>
                <td>  <label for="Age">Employee Age :</label></td>
            </tr> 
            <tr>
                <td><input id="Age" type="number" name="age" placeholder="Write Your Age Here" tabindex="2"  required value="<?= $employee->getAge(); ?>"  ></td>
            </tr>
            <tr>
                <td>  <label for="address" > address :</label></td>
            </tr>
            <tr>
                <td><input id="address" type="text" name="address" placeholder="Write Your Address Here" tabindex="3"  required  value="<?= $employee->getAddress(); ?>"  ></td>
            </tr>
            ...
            <tr>
                <td><input required id="salary" type="number" name="salary" placeholder="Write Your Salary Here" step="0.01"   tabindex="4" min="1500" max="9000" value="<?= $employee->getSalary(); ?>" ></td>
            </tr>
            <tr>
                <td>  <label for="tax"> Employee Tax :  </label></td>
            </tr>
            <tr>
                <td><input required type="number" id="tax" placeholder="Write Tax Here" name="tax" step="0.01"   tabindex="4" min="1" max="5" value="<?= $employee->getTax(); ?>" ></td>
            </tr>
        </table>
    </fieldset>
    <table>
